...
namespace LCL.Events
{
        ...
        where TDomainEvent : class, IDomainEvent
    {
        ...
        public InlineDomainEventHandler(ISourcedAggregateRoot aggregateRoot, MethodInfo mi)
        {
            ...
            {
                throw new ArgumentException(string.Format("The method {0} going to be used as domain event handler doesn't have a correct signature.", mi.Name), "mi");
            }
        ...
        public override int GetHashCode()
        {
            if (this.action != null && this.domainEventType != null)
                return Utility.GetHashCode(this.action.GetHashCode(),
