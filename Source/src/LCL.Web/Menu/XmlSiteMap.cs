...
namespace LCL.Web.Menu
{
    public class XmlSiteMap
    {
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            if (string.IsNullOrWhiteSpace(siteMapNode.ImageUrl)) siteMapNode.ImageUrl = "icon-application";
            // orderby
            siteMapNode.OrderBy = int.Parse(GetStringValueFromAttribute(xmlNode, "order"));
            //permission name
