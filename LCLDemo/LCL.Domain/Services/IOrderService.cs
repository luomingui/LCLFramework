...
namespace LCL.Domain.Services
{
    ...
    public interface IOrderService : IApplicationServiceContract
    {
        ...
        [OperationContract]
        [FaultContract(typeof(FaultData))]
        ShoppingCartModels GetShoppingCart(Guid customerID);
        ...
        [OperationContract]
        [FaultContract(typeof(FaultData))]
        SalesOrder Checkout(Guid customerID);
        ...
        [OperationContract]
        [FaultContract(typeof(FaultData))]
        List<SalesOrder> GetSalesOrdersForUser(Guid userID);
        ...
        [OperationContract]
        [FaultContract(typeof(FaultData))]
        SalesOrder GetSalesOrder(Guid orderID);
        #endregion
    }
}
