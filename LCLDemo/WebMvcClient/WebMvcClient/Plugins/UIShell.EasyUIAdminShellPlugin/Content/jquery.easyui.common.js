...
/* 
easyui tabs组件关闭tab时释放iframe占用内存sss
*/
...
function IframeWindow(title,href,width,height)
{    
...
//    iframe: { src: href }
//});
 http://www.easyui.info/archives/1283.html/comment-page-1?replytocom=3577
 */
...
//            var $maskMessage = $('<div class="mask-message" style="z-index:3;width:auto;height:16px;line-height:16px;position:absolute;top:50%;left:50%;margin-top:-20px;margin-left:-92px;border:2px solid #d4d4d4;padding: 12px 5px 10px 30px;background: #ffffff url(\'/Plugins/UIShell.EasyUIAdminShellPlugin/Content/JQueryEasyUI/themes/default/images/loading.gif\') no-repeat scroll 5px center;">' + (params.iframe.message || 'Processing, please wait ...') + '</div>').appendTo($tabBody);
