...
$('#grid_wfrout').attr('title', $.LCLPageModel.Resource.PageLanguageResource.Page_title); 
    $('#ff_lab_hm_chargeuser_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_ID); 
    $('#ff_lab_hm_chargeuser_user_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_User_ID); 
    $('#ff_lab_hm_chargeuser_isdelete').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_IsDelete); 
    $('#ff_lab_hm_chargeuser_adddate').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_AddDate); 
    $('#ff_lab_hm_chargeuser_updatedate').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_UpdateDate); 
    $('#ff_lab_hm_chargeuser_chargeannual_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_ChargeAnnual_ID); 
    $('#ff_lab_hm_chargeuser_village_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUser_Model_Village_ID); 
...
$.LCLPageModel.Resource.LanguageResourceInfo['2052'] = { 
    ...
    HM_ChargeUser_Model_ID: '编号', 
    HM_ChargeUser_Model_User_ID: '用户', 
    HM_ChargeUser_Model_IsDelete: '删除标记', 
    HM_ChargeUser_Model_AddDate: '添加时间', 
    HM_ChargeUser_Model_UpdateDate: '更新时间', 
    HM_ChargeUser_Model_ChargeAnnual_ID: 'ChargeAnnual_ID', 
    HM_ChargeUser_Model_Village_ID: 'Village_ID', 
}; 
//初始化页面英文资源 
$.LCLPageModel.Resource.LanguageResourceInfo['1033'] = { 
    Page_title: 'HM_ChargeUser', 
    ...
    HM_ChargeUser_Model_ID: 'ID', 
    HM_ChargeUser_Model_User_ID: 'User_ID', 
    HM_ChargeUser_Model_IsDelete: 'IsDelete', 
    HM_ChargeUser_Model_AddDate: 'AddDate', 
    HM_ChargeUser_Model_UpdateDate: 'UpdateDate', 
    HM_ChargeUser_Model_ChargeAnnual_ID: 'ChargeAnnual_ID', 
    HM_ChargeUser_Model_Village_ID: 'Village_ID', 
}; 
