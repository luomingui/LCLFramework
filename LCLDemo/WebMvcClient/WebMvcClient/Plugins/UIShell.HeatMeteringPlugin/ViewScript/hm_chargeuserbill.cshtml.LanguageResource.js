...
$('#grid_wfrout').attr('title', $.LCLPageModel.Resource.PageLanguageResource.Page_title); 
    $('#ff_lab_hm_chargeuserbill_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_ID); 
    $('#ff_lab_hm_chargeuserbill_billnumber').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_BillNumber); 
    $('#ff_lab_hm_chargeuserbill_isdelete').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_IsDelete); 
    $('#ff_lab_hm_chargeuserbill_adddate').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_AddDate); 
    $('#ff_lab_hm_chargeuserbill_updatedate').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_UpdateDate); 
    $('#ff_lab_hm_chargeuserbill_chargeannual_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_ChargeAnnual_ID); 
    $('#ff_lab_hm_chargeuserbill_chargeuser_id').html($.LCLPageModel.Resource.PageLanguageResource.HM_ChargeUserBill_Model_ChargeUser_ID); 
...
$.LCLPageModel.Resource.LanguageResourceInfo['2052'] = { 
    ...
    HM_ChargeUserBill_Model_ID: '编号', 
    HM_ChargeUserBill_Model_BillNumber: '领用票据数量', 
    HM_ChargeUserBill_Model_IsDelete: '删除标记', 
    HM_ChargeUserBill_Model_AddDate: '添加时间', 
    HM_ChargeUserBill_Model_UpdateDate: '更新时间', 
    HM_ChargeUserBill_Model_ChargeAnnual_ID: 'ChargeAnnual_ID', 
    HM_ChargeUserBill_Model_ChargeUser_ID: 'ChargeUser_ID', 
}; 
//初始化页面英文资源 
$.LCLPageModel.Resource.LanguageResourceInfo['1033'] = { 
    Page_title: 'HM_ChargeUserBill', 
    ...
    HM_ChargeUserBill_Model_ID: 'ID', 
    HM_ChargeUserBill_Model_BillNumber: 'BillNumber', 
    HM_ChargeUserBill_Model_IsDelete: 'IsDelete', 
    HM_ChargeUserBill_Model_AddDate: 'AddDate', 
    HM_ChargeUserBill_Model_UpdateDate: 'UpdateDate', 
    HM_ChargeUserBill_Model_ChargeAnnual_ID: 'ChargeAnnual_ID', 
    HM_ChargeUserBill_Model_ChargeUser_ID: 'ChargeUser_ID', 
}; 
