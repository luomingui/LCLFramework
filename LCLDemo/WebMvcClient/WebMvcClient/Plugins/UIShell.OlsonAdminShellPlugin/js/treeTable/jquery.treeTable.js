...
(function ($) {
	...
	if (document.location.href.indexOf('http://') != 0)	{
	    var path = 'Plugins/UIShell.OlsonAdminShellPlugin/js/treeTable/';
	} else {
	    var path = SITE_URL + '/Plugins/UIShell.OlsonAdminShellPlugin/js/treeTable/';
	}
    ...
    $.fn.treeTable = function (opts) {
        ...
        function initRelation($trs, hideLevel) {
            ...
            function getDepth(id) {
                if (cMap[id] == "00000000-0000-0000-0000-000000000000" || cMap[id] == undefined) { return "00000000-0000-0000-0000-000000000000"; }
        ...
        function formatNode(tr) {
            ...
            //-------------下面一大段都是获取$preSpan---------
            if (cMap[id] == "00000000-0000-0000-0000-000000000000") {
