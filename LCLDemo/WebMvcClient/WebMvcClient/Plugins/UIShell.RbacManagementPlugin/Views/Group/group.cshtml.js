...
function InitGrid() { 
    $('#grid_group').datagrid({ 
        ...
        columns: [[ 
                { field: 'ID', title: $.LCLPageModel.Resource.PageLanguageResource.Group_Model_ID, width: 100,hidden:true }, 
                { field: 'Name', title: $.LCLPageModel.Resource.PageLanguageResource.Group_Model_Name, width: 100 }, 
                { field: 'Remark', title: $.LCLPageModel.Resource.PageLanguageResource.Group_Model_Remark, width: 100 }, 
                { field: 'GroupType', title: $.LCLPageModel.Resource.PageLanguageResource.Group_Model_GroupType, width: 100 }, 
