...
function InitGrid() { 
    $('#grid_hostconfig').datagrid({ 
        ...
        columns: [[ 
                { field: 'ID', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_ID, width: 100,hidden:true }, 
                { field: 'Name', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_Name, width: 100 }, 
                { field: 'IP', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_IP, width: 100 }, 
                { field: 'Addess', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_Addess, width: 100 }, 
                { field: 'FtpUser', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_FtpUser, width: 100 }, 
                ...
                { field: 'Flag', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_Flag, width: 100 }, 
                { 
                    field: 'Flag', title: $.LCLPageModel.Resource.PageLanguageResource.HostConfig_Model_Flag, width: 100, formatter: function (value, row, index) { 
